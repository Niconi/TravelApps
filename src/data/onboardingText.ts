...
const onboardingText = [
    {
        id:1,
        Image: require('../presentation/assets/images/onboarding/onboarding1.png'),
    ...
    {
        id:2,
        Image: require('../presentation/assets/images/onboarding/onboarding2.png'),
        HeaderText: 'Get the Best Deal',
    ...
    {
        id:3,
        Image: require('../presentation/assets/images/onboarding/onboarding3.png'),
        HeaderText: 'Explore Local Attractions',
